...
exports.profile=(req,res)=>{
	...
	const Aemail=fname+lname+"@gmail.com"
	console.log(Aemail)
  ...
  // current month
	...
	const user=new User({PIfirstname:fname, PIlastname:lname, PIemail:email, PIphone:phone, PIgender:gender, PIcurrlocation:location, Aemail:Aemail, timestamp:fulldate})
	user.save().then((data)=>{
		res.send(data)
	}).catch((err)=>{
		res.send(err)
